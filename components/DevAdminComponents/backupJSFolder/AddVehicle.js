  ...
  return (
    <>
      ...
      <Box flex={1} justifyContent="center" alignItems={'flex-end'} marginRight={1}>
        ...
        {!modalIsLoading ? (
          <TouchableOpacity onPress={handleModalModelOpen}>
            <Icon as={<MaterialCommunityIcons name="playlist-edit" />} size={5} color="white" />
          </TouchableOpacity>
        ) :
          (<Spinner color="white" />)
  ...
  const SelectFeaturesButton = () => {
    ...
    return (
      <>
        ...
        <Modal isOpen={featuresModalVisible} onClose={handleModalSelectFeaturesClose} size={'full'} useRNModal>
          <Modal.Content bgColor={'white'} w={'80%'} h={'80%'}>
            ...
            {/* <Modal.Body
              ...
              h={'100%'}
            > */}
            <Box flex={1} flexDirection={'column'} margin={10}>
                ...
                <Box px="3" bgColor="#A6BCFE" height="full" flexDir={'column'}>
                        ...
                        <Box margin={2} flex={1} flexDir={['column']} >
                          ...
                          <Box borderColor={'white'} borderWidth={1} ref={inputVehicleBoxRef}>
                            ...
                            <Box flexDir={'row'} borderBottomColor={'white'} borderBottomWidth={'1'}>
                              ...
                              <Box ref={selectRegMonthBoxRef} bgColor={'white'} flex={1} borderColor={regMonthError} borderWidth={1}>
                                ...
                                <SelectDropdown
                                  ...
                                  searchPlaceHolder=" Search for Month"
                                  searchInputStyle={{
                                    marginTop: 1,
                                    flex: 1,
                                    width: '100%',
                            ...
                            <Box flexDir={'row'} borderTopColor={'white'} borderTopWidth={'1'} bgColor={'#8096D7'} >
                              <Box flexDir={'row'} alignSelf={'center'} flex={1} alignItems={'flex-start'}><Text color={'white'} fontSize={[14, 14, 12, 12, 16, 18]}> Supply Chains Costs</Text><Text color={'#D96437'} fontSize={[14, 14, 12, 12, 16, 18]}> *</Text></Box>
                              <Box bgColor={'white'} flex={1} borderColor={isNoFeaturesSelected} borderWidth={1}>
                                <SupplyChainsCosts
                  ...
                  <Box flex={1} margin={1} flexDirection={'column'} h={'full'} display={['none', 'none', 'none', 'none', 'flex', 'flex']}>
                    <Box h={'full'} w={'full'}>
                      ...
                      <Input ref={inputCarName}
                        borderColor={carNameError}
                        placeholder="Car Name" margin={1} bgColor={'white'} borderWidth={1} placeholderTextColor={'muted.400'} />
                        ...
                        <VStack flex={1}>
                          ...
                          <HStack marginTop={1}>
                            <InputGroup flex={1}>
                              ...
                              <Input flex={1} ref={inputCarMemo} borderColor={carNameError} placeholder="Memo" bgColor={'white'} borderWidth={1} placeholderTextColor={'muted.400'} />
                            </InputGroup>
                          </HStack>
